...
***************************************************************************** */
        ...
        function indents() {
            ...
            if (subLinkMenu) {
                ...
                subLinkMenuContent.style.top = hHeader + "px";
            ...
            if (stickyBlocks) {
                const toggleContentActive = document.querySelector(".toggle-content._active");
        ...
        const toggleButtons = document.querySelectorAll(".toggle-navigation__button");
        const tabsTitles = document.querySelectorAll(".toggle-navigation__title");
        function tabsToggle() {
            if (tabsTitles) tabsTitles.forEach((button => {
                const id = button.dataset.id;
                const items = `div[data-id='${id}'].toggle-content`;
                const item = document.querySelector(items);
                if (document.documentElement.clientWidth > 767.98) toggleButtons.forEach((toggleButton => {
                    ...
                    button.classList.contains("_active");
        ...
        if (steps) steps.forEach((step => {
            ...
            if (Array.from(step.querySelectorAll(".select__btntext")).every((li => li.classList.contains("filled")))) buttonNextSteps.forEach((buttonNextStep => {
                buttonNextStep.classList.remove("disabled");
            }));
            show(steps[index]);
            buttonNextSteps.forEach((buttonNextStep => {
                buttonNextStep.addEventListener("click", (function() {
                    ...
                    if (valid) buttonNextStep.classList.add("_active"); else buttonNextStep.classList.remove("_active");
                    show(steps[index]);
                }));
            }));
