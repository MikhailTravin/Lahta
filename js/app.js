 ...
 */
    ...
    (() => {
            ...
            optionMenus.forEach((optionMenu => {
                ...
                if (optionMenu) {
                    selectBtn.addEventListener("click", (function(e) {
                        ...
                        document.documentElement.classList.toggle("select-active");
        ...
        if (document.querySelectorAll(".cars__body").forEach((n => {
            new core(n.querySelector(".cars__slider"), {
                ...
                speed: 800,
                pagination: {
                    el: n.querySelector(".cars__pagination"),
                    clickable: true
                },
                breakpoints: {
                    0: {
        ...
        if (document.querySelector(".used-cars__slider")) {
            var usedCarsSlider = null;
            var mediaQuerySize = 1202;
            function catalogSliderInit() {
                if (!usedCarsSlider) usedCarsSlider = new core(".used-cars__slider", {
                    modules: [ Pagination, Grid ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
        ...
        if (document.querySelectorAll(".used-cars__body").forEach((n => {
            var usedCarsMainSlider = null;
            var mediaQuerySize = 991.98;
            function catalogSliderInit() {
                new core(n.querySelector(".used-cars__main-slider"), {
                    modules: [ Pagination, Grid ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
                    preloadImages: true,
                    pagination: {
                        el: n.querySelector(".used-cars__pagination"),
                        clickable: true
                    },
                    breakpoints: {
                        0: {
            ...
            function catalogSliderDestroy() {
                if (usedCarsMainSlider) {
                    usedCarsMainSlider.destroy();
                    usedCarsMainSlider = null;
                }
            }
            window.addEventListener("resize", (function(e) {
                var windowWidth = window.innerWidth;
        ...
        if (document.querySelector(".right-product-card__slider")) {
            var carsSlider = null;
            mediaQuerySize = 767.98;
            function catalogSliderInit() {
                if (!carsSlider) carsSlider = new core(".right-product-card__slider", {
                    modules: [ Pagination ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
                    ...
                    preloadImages: true,
                    pagination: {
                        el: ".right-product-card__pagination",
                        clickable: true
                    },
                    breakpoints: {
                        0: {
        ...
        if (document.querySelector(".left-product-card__images")) {
        ...
        if (document.querySelector(".popup__images")) {
            const thumbsSwiper = new core(".images-product__popup-thumb", {
            ...
            new core(".images-product__popup-slider", {
                modules: [ Navigation, Thumb ],
                thumbs: {
                    swiper: thumbsSwiper
                },
        ...
        if (document.querySelector(".images-product__images")) new core(".images-product__video-slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelectorAll(".table-main-brands__sliders").forEach((n => {
            new core(n.querySelector(".table-main-brands__slider"), {
                ...
                speed: 800,
                navigation: {
                    prevEl: n.querySelector(".table-main-brands__arrow-prev"),
                    nextEl: n.querySelector(".table-main-brands__arrow-next")
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1
        ...
        if (document.querySelector(".banks__slider")) new core(".banks__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
...
***************************************************************************** */
        ...
        function indents() {
            ...
            const selectTop = document.querySelector(".select__top");
            if (selectTop) {
                const seelctOptions = document.querySelector(".select__options");
                let hselectTop = window.getComputedStyle(selectTop, false).height;
                hselectTop = Number(hselectTop.slice(0, hselectTop.length - 2));
                if (document.documentElement.clientWidth < 767.98) {
                    seelctOptions.style.top = hselectTop + "px";
                    seelctOptions.style.height = `calc(100vh - ${hselectTop}px)`;
                } else {
                    seelctOptions.style.top = "0px";
                    seelctOptions.style.height = "auto";
                }
            }
            const subLinkMenu = document.querySelector(".sublink-menu__top");
            if (subLinkMenu) {
                const subLinkMenuContent = document.querySelector(".sublink-menu__content");
                let subLinkNav = document.querySelector(".sublink-menu__navigation");
                let hsubLinkMenu = window.getComputedStyle(subLinkMenu, false).height;
                hsubLinkMenu = Number(hsubLinkMenu.slice(0, hsubLinkMenu.length - 2));
                let hsubLinkNav = window.getComputedStyle(subLinkNav, false).height;
                hsubLinkNav = Number(hsubLinkNav.slice(0, hsubLinkNav.length - 2));
                if (document.documentElement.clientWidth < 991.98) {
                    let sumHeight = hsubLinkMenu + hsubLinkMenu;
                    subLinkMenuContent.style.top = sumHeight + "px";
                    subLinkMenuContent.style.minHeight = `calc(100vh - ${hsubLinkMenu}px)`;
                    subLinkMenuContent.style.height = `calc(100vh - ${hsubLinkMenu}px)`;
                } else {
                    subLinkMenuContent.style.top = hsubLinkNav + "px";
                    subLinkMenuContent.style.minHeight = `calc(100vh - ${hsubLinkNav}px)`;
                    subLinkMenuContent.style.height = `calc(100vh - ${hsubLinkNav}px)`;
                }
            }
            const menuBrands = document.querySelector(".menu-brands");
            if (menuBrands) {
                menuBrands.style.top = hHeader + "px";
                menuBrands.style.height = `calc(100vh - ${hHeader}px)`;
            }
            let stickyBlocks = document.querySelectorAll(".comparision__sticky");
            if (stickyBlocks) {
                const toggleContentActive = document.querySelector(".comparision__body");
                stickyBlocks.forEach((stickyBlock => {
                    const startPoint = stickyBlock.getBoundingClientRect().top + scrollY - hHeader;
                    const endPoint = stickyBlock.getBoundingClientRect().top + hHeader;
                    if (document.documentElement.clientWidth > 1202 && toggleContentActive) if (scrollY >= startPoint && scrollY > endPoint) {
                        stickyBlock.classList.add("_sticky");
                        stickyBlock.style.position = "fixed";
                        stickyBlock.style.top = hHeader + "px";
                    } else {
                        stickyBlock.classList.remove("_sticky");
        ...
        if (menuLinks) menuLinks.forEach((link => {
            const menuCloses = document.querySelectorAll(".sublink-menu__close");
            const menuBacks = document.querySelectorAll(".sublink-menu__back");
            ...
            menuCloses.forEach((close => {
                close.addEventListener("click", (function(e) {
                    const menuItemActive = document.querySelector(".menu__item._active");
                    if (menuItemActive) menuItemActive.classList.remove("_active");
        ...
        if (filters) {
            const buttonsSelector = `${filters} .navigation-filter`;
        ...
        const tabFilterTitles = document.querySelectorAll(".main-brand__tab-title");
        if (tabFilterTitles) tabFilterTitles.forEach((title => {
            title.addEventListener("click", (function(e) {
                tabFilterTitles.forEach((el => {
                    el.classList.remove("_filter-tab-active");
                }));
                title.classList.add("_filter-tab-active");
                document.documentElement.classList.toggle("_filter-tab-active");
            }));
        }));
        ...
        const help = document.querySelector(".certificate-right-product-card__help");
        if (help) {
            help.addEventListener("click", (function(e) {
                help.classList.toggle("_active");
            }));
            window.addEventListener("click", (function(e) {
                let target = e.target;
                if (!target.closest(".certificate-right-product-card__help") && !target.closest(".certificate-right-product-card__help-list")) help.classList.remove("_active");
            }));
        }
        ...
        const formsInputs = document.querySelectorAll(".forms-tabs__input");
        if (formsInputs) formsInputs.forEach((input => {
            const clear = input.querySelector(".forms-tabs__close");
            const inputs = input.querySelector(".forms-tabs__input input");
        ...
        const consultantClose = document.querySelector(".consultant__close");
        if (consultant) consultantClose.addEventListener("click", (function(e) {
            consultant.classList.add("hidden");
        }));
        const steps = document.querySelectorAll(".step-credit");
        if (steps) {
            let stepActive = document.querySelector(".step-credit._active");
            let li = document.querySelectorAll("input");
            let li_filled = document.querySelectorAll("input.filled");
            if (stepActive) if (li.length == li_filled.length) button.classList.remove("disabled");
            steps.forEach((step => {
                const buttonPrevSteps = document.querySelectorAll(".button-back");
                const buttonNextSteps = document.querySelectorAll(".button-on");
                document.querySelector(".button-submit");
                let index = 0;
                const optionsInputs = document.querySelectorAll(".options__item");
                if (optionsInputs) optionsInputs.forEach((input => {
        ...
        if (videosWrap) {
            const videoEventHandler = e => {
                ...
                if (video.classList.contains("isPlaying")) video.play(); else video.pause();
                video.classList.toggle("isPlaying");
                window.addEventListener("click", (e => {
                    const target = e.target;
                    if (!target.closest(".images-product__videos") && !target.closest("_icon-youtube")) {
                        video.pause();
